function [] = resetTimestepAnalysisData(analysisFolderPath,noWarning)
%RESET TIME STEP ANALYSIS DATA - clear timestep analysis output data in memory
%
%   Syntax:
%       [] = resetTimestepAnalysisData(analysisFolderPath,noWarning)
%   
%   Input:
%       analysisFolderPath, path:  sensitivity-box directory
...
%
%   Directory to cleaned-up in sensitivity-timestep analysis:
%       ./..                            --> all .mat

...
t4 = tiledlayout(1,3);
    ...
    nexttile
    chordwiseCp_plot('08','0',1);
    title('station $$y/b=0.20$$');

    nexttile
    chordwiseCp_plot('08','0',2);
    title('station $$y/b=0.65$$');

    nexttile
    chordwiseCp_plot('08','0',3);
    title('station $$y/b=0.95$$');
...
t5 = tiledlayout(1,3);
    ...
    nexttile
    chordwiseCp_plot('08','3',1);
    title('station $$y/b=0.20$$');

    nexttile
    chordwiseCp_plot('08','3',2);
    title('station $$y/b=0.65$$');

    nexttile
    chordwiseCp_plot('08','3',3);
    title('station $$y/b=0.95$$');
...
t6 = tiledlayout(1,3);
    ...
    nexttile
    chordwiseCp_plot('08','6',1);
    title('station $$y/b=0.20$$');

    nexttile
    chordwiseCp_plot('08','6',2);
    title('station $$y/b=0.65$$');

    nexttile
    chordwiseCp_plot('08','6',3);
    title('station $$y/b=0.95$$');

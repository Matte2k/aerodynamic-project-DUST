function [] = resetDustData(analysisFolderPath,noWarning)
%RESET DUST DATA - clear dust analysis folder from output data in memory
%
%   Syntax:
%       [] = resetDustData(analysisFolderPath,noWarning)
%   
%   Input:
...
%       ./input-DUST/geometry-data/..   --> all .in 
%

function [] = resetBoxAnalysisData(analysisFolderPath,noWarning)
%RESET BOX ANALYSIS DATA - clear box analysis output data in memory
%
%   Syntax:
%       [] = resetBoxAnalysisData(analysisFolderPath,noWarning)
%   
%   Input:

...
%
    ...
    % wing loads
    data.wing.Cl  = [ 0.076568,     0.179898,     0.282631];
    data.wing.Cd  = [ 0.000418,     0.001790,     0.031391];
    data.wing.Cm  = [-0.037633,    -0.015473,    -0.009213];
    
    % tail loads
    data.tail.Cl  = [ 0.013657,     0.021264,     0.027360];
    data.tail.Cd  = [-0.000599,    -0.000027,     0.002028];
    data.tail.Cm  = [-0.021216,    -0.033363,    -0.043526];

    % aircraft loads
    data.total.Cl  = [ 0.129478,     0.319120,     0.542844];
    data.total.Cd  = [ 0.052441,     0.060039,     0.112898];
    data.total.Cm  = [-0.029561,    -0.004596,     0.074728];

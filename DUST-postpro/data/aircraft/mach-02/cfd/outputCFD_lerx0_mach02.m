...
%               > ./data/aircraft/mach-02/aoa5/lerx0_forces_breakdown.dat
...
%
    ...
    % tail loads
    data.tail.Cl  = [ 0.000000,     0.000000,     0.000000];
    data.tail.Cd  = [ 0.000000,     0.000000,     0.000000];
    data.tail.Cm  = [ 0.000000,     0.000000,     0.000000];

    % aircraft loads
    data.total.Cl  = [ 0.000000,     0.000000,     0.000000];
    data.total.Cd  = [ 0.000000,     0.000000,     0.000000];
    data.total.Cm  = [ 0.000000,     0.000000,     0.000000];

function [data] = outputCFD_wing_mach05()
%OUTPUT CFD only WING at MACH 0.5000
%
%   Syntax:
%       [data] = outputCFD_wing_mach05()
%
%   Input:
%       []
%
...
%               > ./data/wing/mach-05/cfd/aoa2/forces_breakdown.dat
%               > ./data/wing/mach-05/cfd/aoa5/forces_breakdown.dat
%               > ./data/wing/mach-05/cfd/aoa10/forces_breakdown.dat
